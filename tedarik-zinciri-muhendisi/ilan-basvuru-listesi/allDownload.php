...
// Start the backup!
zipData('/home/bosch/tedarik-zinciri-muhendisi/uploads', 'uploads/allCV.zip');

// Here the magic happens :)
function zipData($folder, $zipTo)
{
    array_map( 'unlink', array_filter((array) glob("/home/bosch/tedarik-zinciri-muhendisi/ilan-basvuru-listesi/uploads") ) );
