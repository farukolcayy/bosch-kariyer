...
<head>
    ...
    <title>Üretim Mühendisi-1 - Başvurular</title>
                ...
                <div class="table-responsive" style="margin-top: 100px;">
                    <table style="display:none;" id="datatable2">
                        ...
                        <tbody>
                            ...
                            $query = $db->query("SELECT * FROM uretim_muhendisi_1 group by emailAddress ORDER BY `uretim_muhendisi_1`.`dateTime` DESC");
                    ...
                    <table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            while ($row = $query->fetch_assoc()) {
                                ...
                                echo '<td>' . $row['graduationYear'] . '</td>';
                                echo '<td>' . $row['dateTime'] . '</td>';
                                echo '<td><a href="https://bosch.ogrencikariyeri.com/uretim-muhendisi-1/uploads/' . $row['cvPath'] . '" download="' . $row['cvPath'] . '" >
            ...
            $("#exportCv").click(function() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        window.location = "https://bosch.ogrencikariyeri.com/uretim-muhendisi-1/ilan-basvuru-listesi/uploads/allCV.zip";
                    }
                });
            });
