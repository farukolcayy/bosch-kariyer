...
// Start the backup!
zipData('/home/bosch/uretim-muhendisi-1/uploads', 'uploads/allCV.zip');

// Here the magic happens :)
function zipData($folder, $zipTo)
{
    array_map( 'unlink', array_filter((array) glob("/home/bosch/uretim-muhendisi-1/ilan-basvuru-listesi/uploads") ) );
