...
<head>
    ...
    <title>GlobalBilgi Başvurular</title>
                ...
                <div class="table-responsive" style="margin-top: 100px;">
                    <table style="display:none;" id="datatable2">
                        ...
                        <tbody>
                            ...
                            $query = $db->query("SELECT * FROM basvuru group by emailAddress ORDER BY `basvuru`.`applyDate` DESC");
        ...
        $(document).ready(function() {
            ...
            $("#exportButton").click(function() {
                $("#datatable2").table2excel({
                    name: "Başvurular",
                    filename: "GlobalBilgi Başvurular", //do not include extension
