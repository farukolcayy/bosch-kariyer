...
<head>
    ...
    <title>Yazılım Geliştirme Mühendisi-Başvurular</title>

    <head>
        <link href="https://fonts.googleapis.com/css?family=Lato:300,400,400i,700|Poppins:300,400,500,600,700|PT+Serif:400,400i&display=swap" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="css/bootstrap.css" type="text/css" />
        <link rel="stylesheet" href="css/bs-datatable.css" type="text/css" />
        <link rel="stylesheet" href="css/style.css?=1.3" type="text/css" />
                ...
                <div class="table-responsive" style="margin-top: 100px;">
                    <table style="display:none;" id="datatable2">
                        ...
                        <tbody>
                            ...
                            $query = $db->query("SELECT * FROM yazilim_gelistirme_muhendisi group by emailAddress ORDER BY `yazilim_gelistirme_muhendisi`.`dateTime` DESC");
                    ...
                    <table id="datatable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            while ($row = $query->fetch_assoc()) {
                                ...
                                echo '<td>' . $row['graduationYear'] . '</td>';
                                echo '<td>' . $row['dateTime'] . '</td>';
                                echo '<td><a href="https://bosch.ogrencikariyeri.com/yazilim-gelistirme-muhendisi/uploads/' . $row['cvPath'] . '" download="' . $row['cvPath'] . '" >
        ...
        $(document).ready(function() {
            ...
            $("#exportButton").click(function() {
                $("#datatable2").table2excel({
                    name: "Başvurular",
                    filename: "Lojistik Planlama Mühendisi Başvuruları", //do not include extension
            ...
            $("#exportCv").click(function() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        window.location = "https://bosch.ogrencikariyeri.com/yazilim-gelistirme-muhendisi/ilan-basvuru-listesi/uploads/allCV.zip";
                    }
                });
            });
